...
BURIQ () {
    ...
    curl -sS https://raw.githubusercontent.com/PiqaronaDev/auth/refs/heads/main/reg > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/PiqaronaDev/auth/refs/heads/main/reg | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    ...
    IZIN=$(curl -sS https://raw.githubusercontent.com/PiqaronaDev/auth/refs/heads/main/reg | awk '{print $4}' | grep $MYIP)
...
Exp=$(curl -sS https://raw.githubusercontent.com/PiqaronaDev/auth/refs/heads/main/reg | grep $MYIP | awk '{print $3}')
fi
...
export sem=$( curl -s https://raw.githubusercontent.com/PiqaronaDev/script/refs/heads/main/version)
