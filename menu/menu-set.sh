...
echo -e "  ${BICyan}[${BIWhite}02${BICyan}] CHANGE ALL PORT"
echo -e "  ${BICyan}[${BIWhite}03${BICyan}] MENU WEBMIN"
...
echo -e "  ${BICyan}[${BIWhite}09${BICyan}] BANDWITH"
...
0) clear ; menu ; exit ;;
x) exit ;;
*) echo -e "" ; echo "wrong input" ; sleep 1 ; menu-set ;;
esac
